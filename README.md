...
variety of continuous or pulse-like gas density distributions,
and the velocity profile, including the so-called beta law from approximations
to CAK theory (Castor et al. 1975, Pauldrach et al. 1986) and other power law
...
model = OL.Emission([4958.911,5006.843],Geometry='HollowCones',AddStatic=True,Disk=True)
...
density, CAK approximation model for analysis of Mrk 462, which was presented in
