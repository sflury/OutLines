from OutLines import __emission__,__absorption__
from OutLines.__funcs__ import gauss,voigt
from OutLines.__params__ import *
from functools import partial
# numpy functions for some basics
from numpy import array, exp, log, pi, inf, interp, argmin, nansum, isfinite, where
...
def profile_constructor(ProfileSubClass):
    ...
    Arguments:
        :ProfileSubClass (*class*): object class of `Emission` or `Absorption`

    Returns:
        :Profile (*object*): An instance of the Profile object class inhereting
                the Emisison or Absorption class with properties specific to the
                related spectral line
    ...
    class Profile(ProfileSubClass):
        ...
        Bound methods for viewing, updating, and computing the line profile:
            ...
            :print_bounds: prints profile model settings to the command line
        ...
        def __init__(self,*args,VelocityField='BetaCAK',DensityProfile='PowerLaw',\
                    Geometry='Spherical',AddStatic=False,Disk=False,Aperture=False):
            ...
            if hasattr(args[0],'__len__'):
                ...
                if ProfileSubClass.__name__ != 'Emission':
                    ...
                    # otherwise, inform the user and call it quits
                        ...
                        print('OutLines requires the same number of oscilator'+\
                            ...
                            '\nAbsorption and PCygni line profiles')
                        sys.exit()
            else:
                self.w0 = array([args[0]])
                # if absorption is present, set the oscilator strength if given
        ...
        def print_params(self):
            ...
            for param,value in iter(self.params.items()):
                if 'Terminal' in param or 'Doppler' in param:
        ...
        def velocity_quantiles(self,quantiles=array([0.1,0.9]),verbose=True):
            ...
            if self.settings['Profile'] == 'Emission' :
                ...
                print('Try again using Emission or Absorption profiles')
...
class Emission():
    ...
    Purpose:
        Compute a model spectral emission line profile for outflowing gas for the
    ...
    Returns:
        :Profile (*object*): An instance of the Profile object class inhereting
                the Emisison class with properties specific to an emission line
    ...
    def __init__(self,w0):
        kwargs = {k:self.settings[k] for k in \
            ['VelocityField','DensityProfile','Geometry','Disk','Aperture']}
        self.OutLinesModel = __emission__.build_profile_model(**kwargs)
        pass
...
class Absorption():
    ...
    def __WithStatic__(self,w,sigv,vinf,beta,*pars):
        ...
        return exp( taus@static + tauo@outflow )
    def __WithoutStatic__(self,w,vinf,beta,*pars):
        outflow = array(list(map(lambda w0: \
